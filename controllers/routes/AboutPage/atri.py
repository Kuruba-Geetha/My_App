...
class Atri:
	def __init__(self, state: Any):
		...
		self.AboutPage = state["AboutPage"]
		self.imgFlex = state["imgFlex"]
		self.visitFlex = state["visitFlex"]
		self.addrFlex = state["addrFlex"]
		self.contactFlex = state["contactFlex"]
		self.mailFlex = state["mailFlex"]
		self.usFlex = state["usFlex"]
		...
		self.visitText = state["visitText"]
		self.locationIcon = state["locationIcon"]
		self.address = state["address"]
		self.number = state["number"]
		self.phoneIcon = state["phoneIcon"]
		self.maiId = state["maiId"]
		self.maiIcon = state["maiIcon"]
		self.text1 = state["text1"]
		self.text2 = state["text2"]
		self.aboutUs = state["aboutUs"]
		self.aboutUsBtn = state["aboutUsBtn"]
		self.joinBtn = state["joinBtn"]
		self._setter_access_tracker = {}
	...
	@property
	def AboutPage(self):
		self._getter_access_tracker["AboutPage"] = {}
		return self._AboutPage
	@AboutPage.setter
	def AboutPage(self, new_state):
		self._setter_access_tracker["AboutPage"] = {}
		global default_state
		self._AboutPage = Flex(new_state, default_state["AboutPage"])

	@property
	def imgFlex(self):
		self._getter_access_tracker["imgFlex"] = {}
		return self._imgFlex
	@imgFlex.setter
	def imgFlex(self, new_state):
		self._setter_access_tracker["imgFlex"] = {}
		global default_state
		self._imgFlex = Flex(new_state, default_state["imgFlex"])

	@property
	def visitFlex(self):
		self._getter_access_tracker["visitFlex"] = {}
		return self._visitFlex
	@visitFlex.setter
	def visitFlex(self, new_state):
		self._setter_access_tracker["visitFlex"] = {}
		global default_state
		self._visitFlex = Flex(new_state, default_state["visitFlex"])

	@property
	def addrFlex(self):
		self._getter_access_tracker["addrFlex"] = {}
		return self._addrFlex
	@addrFlex.setter
	def addrFlex(self, new_state):
		self._setter_access_tracker["addrFlex"] = {}
		global default_state
		self._addrFlex = Flex(new_state, default_state["addrFlex"])
	...
	@property
	def mailFlex(self):
		self._getter_access_tracker["mailFlex"] = {}
		return self._mailFlex
	@mailFlex.setter
	def mailFlex(self, new_state):
		self._setter_access_tracker["mailFlex"] = {}
		global default_state
		self._mailFlex = Flex(new_state, default_state["mailFlex"])

	@property
	def usFlex(self):
		self._getter_access_tracker["usFlex"] = {}
		return self._usFlex
	@usFlex.setter
	def usFlex(self, new_state):
		self._setter_access_tracker["usFlex"] = {}
		global default_state
		self._usFlex = Flex(new_state, default_state["usFlex"])
	...
	def Image(self, new_state):
		...
		global default_state
		self._Image = Image(new_state, default_state["Image"])
	...
	@property
	def visitText(self):
		self._getter_access_tracker["visitText"] = {}
		return self._visitText
	@visitText.setter
	def visitText(self, new_state):
		self._setter_access_tracker["visitText"] = {}
		global default_state
		self._visitText = TextBox(new_state, default_state["visitText"])

	@property
	def locationIcon(self):
		self._getter_access_tracker["locationIcon"] = {}
		return self._locationIcon
	@locationIcon.setter
	def locationIcon(self, new_state):
		self._setter_access_tracker["locationIcon"] = {}
		global default_state
		self._locationIcon = Image(new_state, default_state["locationIcon"])
	...
	@property
	def number(self):
		self._getter_access_tracker["number"] = {}
		return self._number
	@number.setter
	def number(self, new_state):
		self._setter_access_tracker["number"] = {}
		global default_state
		self._number = TextBox(new_state, default_state["number"])

	@property
	def phoneIcon(self):
		self._getter_access_tracker["phoneIcon"] = {}
		return self._phoneIcon
	@phoneIcon.setter
	def phoneIcon(self, new_state):
		self._setter_access_tracker["phoneIcon"] = {}
		global default_state
		self._phoneIcon = Image(new_state, default_state["phoneIcon"])

	@property
	def maiId(self):
		self._getter_access_tracker["maiId"] = {}
		return self._maiId
	@maiId.setter
	def maiId(self, new_state):
		self._setter_access_tracker["maiId"] = {}
		global default_state
		self._maiId = TextBox(new_state, default_state["maiId"])

	@property
	def maiIcon(self):
		self._getter_access_tracker["maiIcon"] = {}
		return self._maiIcon
	@maiIcon.setter
	def maiIcon(self, new_state):
		self._setter_access_tracker["maiIcon"] = {}
		global default_state
		self._maiIcon = Image(new_state, default_state["maiIcon"])
	...
	def aboutUs(self, new_state):
		...
		global default_state
		self._aboutUs = TextBox(new_state, default_state["aboutUs"])

	@property
	def aboutUsBtn(self):
		self._getter_access_tracker["aboutUsBtn"] = {}
		return self._aboutUsBtn
	@aboutUsBtn.setter
	def aboutUsBtn(self, new_state):
		self._setter_access_tracker["aboutUsBtn"] = {}
		global default_state
		self._aboutUsBtn = Button(new_state, default_state["aboutUsBtn"])

	@property
	def joinBtn(self):
		self._getter_access_tracker["joinBtn"] = {}
		return self._joinBtn
	@joinBtn.setter
	def joinBtn(self, new_state):
		self._setter_access_tracker["joinBtn"] = {}
		global default_state
		self._joinBtn = Button(new_state, default_state["joinBtn"])

	def _to_json_fields(self):
		return {
			"AboutPage": self._AboutPage,
			"imgFlex": self._imgFlex,
			"visitFlex": self._visitFlex,
			"addrFlex": self._addrFlex,
			"contactFlex": self._contactFlex,
			"mailFlex": self._mailFlex,
			"usFlex": self._usFlex,
			"Flex85": self._Flex85,
			"Flex88": self._Flex88,
			"Image": self._Image,
			...
			"visitText": self._visitText,
			"locationIcon": self._locationIcon,
			"address": self._address,
			"number": self._number,
			"phoneIcon": self._phoneIcon,
			"maiId": self._maiId,
			"maiIcon": self._maiIcon,
			"text1": self._text1,
			"text2": self._text2,
			"aboutUs": self._aboutUs,
			"aboutUsBtn": self._aboutUsBtn,
			"joinBtn": self._joinBtn,
			}
